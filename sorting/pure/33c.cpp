...
const rapidcsv::Document LT_CSV("../datasets/job/33c/lt.csv", NO_HEADERS, SEPARATOR);
...
const rapidcsv::Document IT1_CSV("../datasets/job/33c/it1.csv", NO_HEADERS, SEPARATOR);
auto it1 = tuple(/* id */ IT1_CSV.GetColumn<int>(0), /* size */ static_cast<int>(IT1_CSV.GetRowCount()));
const rapidcsv::Document MI_IDX2_CSV("../datasets/job/33c/mi_idx2.csv", NO_HEADERS, SEPARATOR);
...
const rapidcsv::Document IT2_CSV("../datasets/job/33c/it2.csv", NO_HEADERS, SEPARATOR);
...
const rapidcsv::Document KT1_CSV("../datasets/job/33c/kt1.csv", NO_HEADERS, SEPARATOR);
auto kt1 = tuple(/* id */ KT1_CSV.GetColumn<int>(0), /* size */ static_cast<int>(KT1_CSV.GetRowCount()));
const rapidcsv::Document T2_CSV("../datasets/job/33c/t2.csv", NO_HEADERS, SEPARATOR);
...
const rapidcsv::Document KT2_CSV("../datasets/job/33c/kt2.csv", NO_HEADERS, SEPARATOR);
...
const rapidcsv::Document CN1_CSV("../datasets/job/33c/cn1.csv", NO_HEADERS, SEPARATOR);
