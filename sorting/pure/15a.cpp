...
const rapidcsv::Document T_CSV("../datasets/job/15a/t.csv", NO_HEADERS, SEPARATOR);
auto t = tuple(/* id */ T_CSV.GetColumn<int>(0), /* title */ T_CSV.GetColumn<string>(1), /* size */ static_cast<int>(T_CSV.GetRowCount()));
const rapidcsv::Document MI_CSV("../datasets/job/15a/mi.csv", NO_HEADERS, SEPARATOR);
...
const rapidcsv::Document MC_CSV("../datasets/job/15a/mc.csv", NO_HEADERS, SEPARATOR);
...
const rapidcsv::Document IT1_CSV("../datasets/job/15a/it1.csv", NO_HEADERS, SEPARATOR);
...
const rapidcsv::Document CN_CSV("../datasets/job/15a/cn.csv", NO_HEADERS, SEPARATOR);
