...
const rapidcsv::Document MC_CSV("../datasets/job/1a/mc.csv", NO_HEADERS, SEPARATOR);
...
const rapidcsv::Document IT_CSV("../datasets/job/1a/it.csv", NO_HEADERS, SEPARATOR);
auto it = tuple(/* id */ IT_CSV.GetColumn<int>(0), /* size */ static_cast<int>(IT_CSV.GetRowCount()));
const rapidcsv::Document CT_CSV("../datasets/job/1a/ct.csv", NO_HEADERS, SEPARATOR);
