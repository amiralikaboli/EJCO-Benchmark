...
const rapidcsv::Document T_CSV("../datasets/job/6a/t.csv", NO_HEADERS, SEPARATOR);
auto t = tuple(/* id */ T_CSV.GetColumn<int>(0), /* title */ T_CSV.GetColumn<string>(1), /* size */ static_cast<int>(T_CSV.GetRowCount()));
const rapidcsv::Document K_CSV("../datasets/job/6a/k.csv", NO_HEADERS, SEPARATOR);
...
const rapidcsv::Document N_CSV("../datasets/job/6a/n.csv", NO_HEADERS, SEPARATOR);
