...
const rapidcsv::Document T_CSV("../datasets/job/3c/t.csv", NO_HEADERS, SEPARATOR);
auto t = tuple(/* id */ T_CSV.GetColumn<int>(0), /* title */ T_CSV.GetColumn<string>(1), /* size */ static_cast<int>(T_CSV.GetRowCount()));
const rapidcsv::Document MI_CSV("../datasets/job/3c/mi.csv", NO_HEADERS, SEPARATOR);
auto mi = tuple(/* movie_id */ MI_CSV.GetColumn<int>(1), /* size */ static_cast<int>(MI_CSV.GetRowCount()));
const rapidcsv::Document K_CSV("../datasets/job/3c/k.csv", NO_HEADERS, SEPARATOR);
