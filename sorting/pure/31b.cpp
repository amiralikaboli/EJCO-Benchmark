...
vector<tuple<int, int, int, string, int, int, string, string, int>> interm1;
...
interm1.emplace_back(get<0>(mi)[mi_off], get<0>(mi)[mi_off], get<1>(mi)[mi_off], get<2>(mi)[mi_off], get<1>(interm0_tuple), get<3>(interm0_tuple), get<2>(interm0_tuple), get<4>(interm0_tuple), get<1>(mc)[mc_off]);}
}
}
}
}
...
sort(interm1.begin(), interm1.end(), [](const tuple<int, int, int, string, int, int, string, string, int> &a, const tuple<int, int, int, string, int, int, string, string, int> &b) { return get<0>(a) < get<0>(b); });
