...
const rapidcsv::Document CCT1_CSV("../datasets/job/29b/cct1.csv", NO_HEADERS, SEPARATOR);
auto cct1 = tuple(/* id */ CCT1_CSV.GetColumn<int>(0), /* size */ static_cast<int>(CCT1_CSV.GetRowCount()));
const rapidcsv::Document CCT2_CSV("../datasets/job/29b/cct2.csv", NO_HEADERS, SEPARATOR);
auto cct2 = tuple(/* id */ CCT2_CSV.GetColumn<int>(0), /* size */ static_cast<int>(CCT2_CSV.GetRowCount()));
const rapidcsv::Document T_CSV("../datasets/job/29b/t.csv", NO_HEADERS, SEPARATOR);
...
const rapidcsv::Document CN_CSV("../datasets/job/29b/cn.csv", NO_HEADERS, SEPARATOR);
...
const rapidcsv::Document K_CSV("../datasets/job/29b/k.csv", NO_HEADERS, SEPARATOR);
auto k = tuple(/* id */ K_CSV.GetColumn<int>(0), /* size */ static_cast<int>(K_CSV.GetRowCount()));
const rapidcsv::Document MI_CSV("../datasets/job/29b/mi.csv", NO_HEADERS, SEPARATOR);
...
const rapidcsv::Document IT_CSV("../datasets/job/29b/it.csv", NO_HEADERS, SEPARATOR);
...
const rapidcsv::Document IT3_CSV("../datasets/job/29b/it3.csv", NO_HEADERS, SEPARATOR);
auto it3 = tuple(/* id */ IT3_CSV.GetColumn<int>(0), /* size */ static_cast<int>(IT3_CSV.GetRowCount()));
const rapidcsv::Document N_CSV("../datasets/job/29b/n.csv", NO_HEADERS, SEPARATOR);
auto n = tuple(/* id */ N_CSV.GetColumn<int>(0), /* name */ N_CSV.GetColumn<string>(1), /* size */ static_cast<int>(N_CSV.GetRowCount()));
const rapidcsv::Document CI_CSV("../datasets/job/29b/ci.csv", NO_HEADERS, SEPARATOR);
...
const rapidcsv::Document CHN_CSV("../datasets/job/29b/chn.csv", NO_HEADERS, SEPARATOR);
auto chn = tuple(/* id */ CHN_CSV.GetColumn<int>(0), /* name */ CHN_CSV.GetColumn<string>(1), /* size */ static_cast<int>(CHN_CSV.GetRowCount()));
const rapidcsv::Document RT_CSV("../datasets/job/29b/rt.csv", NO_HEADERS, SEPARATOR);
