...
const rapidcsv::Document T_CSV("../datasets/job/19d/t.csv", NO_HEADERS, SEPARATOR);
...
const rapidcsv::Document IT_CSV("../datasets/job/19d/it.csv", NO_HEADERS, SEPARATOR);
auto it = tuple(/* id */ IT_CSV.GetColumn<int>(0), /* size */ static_cast<int>(IT_CSV.GetRowCount()));
const rapidcsv::Document CN_CSV("../datasets/job/19d/cn.csv", NO_HEADERS, SEPARATOR);
auto cn = tuple(/* id */ CN_CSV.GetColumn<int>(0), /* size */ static_cast<int>(CN_CSV.GetRowCount()));
const rapidcsv::Document N_CSV("../datasets/job/19d/n.csv", NO_HEADERS, SEPARATOR);
...
const rapidcsv::Document CI_CSV("../datasets/job/19d/ci.csv", NO_HEADERS, SEPARATOR);
...
const rapidcsv::Document RT_CSV("../datasets/job/19d/rt.csv", NO_HEADERS, SEPARATOR);
