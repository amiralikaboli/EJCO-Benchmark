...
const rapidcsv::Document CCT1_CSV("../datasets/job/20a/cct1.csv", NO_HEADERS, SEPARATOR);
auto cct1 = tuple(/* id */ CCT1_CSV.GetColumn<int>(0), /* size */ static_cast<int>(CCT1_CSV.GetRowCount()));
const rapidcsv::Document CCT2_CSV("../datasets/job/20a/cct2.csv", NO_HEADERS, SEPARATOR);
...
const rapidcsv::Document T_CSV("../datasets/job/20a/t.csv", NO_HEADERS, SEPARATOR);
...
const rapidcsv::Document KT_CSV("../datasets/job/20a/kt.csv", NO_HEADERS, SEPARATOR);
auto kt = tuple(/* id */ KT_CSV.GetColumn<int>(0), /* size */ static_cast<int>(KT_CSV.GetRowCount()));
const rapidcsv::Document K_CSV("../datasets/job/20a/k.csv", NO_HEADERS, SEPARATOR);
...
const rapidcsv::Document CHN_CSV("../datasets/job/20a/chn.csv", NO_HEADERS, SEPARATOR);
