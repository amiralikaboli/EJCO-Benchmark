...
const rapidcsv::Document CCT1_CSV("../datasets/job/23a/cct1.csv", NO_HEADERS, SEPARATOR);
auto cct1 = tuple(/* id */ CCT1_CSV.GetColumn<int>(0), /* size */ static_cast<int>(CCT1_CSV.GetRowCount()));
const rapidcsv::Document T_CSV("../datasets/job/23a/t.csv", NO_HEADERS, SEPARATOR);
...
const rapidcsv::Document KT_CSV("../datasets/job/23a/kt.csv", NO_HEADERS, SEPARATOR);
...
const rapidcsv::Document CN_CSV("../datasets/job/23a/cn.csv", NO_HEADERS, SEPARATOR);
...
const rapidcsv::Document MI_CSV("../datasets/job/23a/mi.csv", NO_HEADERS, SEPARATOR);
...
const rapidcsv::Document IT1_CSV("../datasets/job/23a/it1.csv", NO_HEADERS, SEPARATOR);
