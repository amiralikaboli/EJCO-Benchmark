...
const rapidcsv::Document MI_CSV("../datasets/job/19a/mi.csv", NO_HEADERS, SEPARATOR);
...
const rapidcsv::Document CI_CSV("../datasets/job/19a/ci.csv", NO_HEADERS, SEPARATOR);
...
const rapidcsv::Document RT_CSV("../datasets/job/19a/rt.csv", NO_HEADERS, SEPARATOR);
