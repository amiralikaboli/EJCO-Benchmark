...
interm3_trie0[get<0>(mc)[mc_off]][tuple<int, int, string, string, string>(get<1>(mc)[mc_off], get<2>(mc)[mc_off], get<1>(cn)[cn_off], get<1>(interm2_tuple), get<2>(interm2_tuple))] += 1;
}
}
}
}
